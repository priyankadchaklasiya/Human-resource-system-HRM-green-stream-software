...
?>
<title><?= $page_title ?>green straem software</title>
	   ...
	   <div class="mother-grid-inner">
               <!--header start here-->
				<div class="header-main">
					<div style="padding: 1.15em; margin-right: 0%; width: 100%;" class="logo-w3-agile">
						<h1 clas><a href="index.php"> EMPLOYEE REGISTRATATION</a></h1>
					</div>
