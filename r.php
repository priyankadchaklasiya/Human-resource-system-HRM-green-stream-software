...
<script>
function fun() {
var course = confirm("Are you sure for this registartion?");
if (course==true)  
{
document.write("<h2 style='color:green'>Congratulations! You have taken right decision! You will be part of the Green Stream Software</h2>");
}else    
{
document.write("<h2 style='color:red'>Sorry!");
}
}
</script>
<script>
